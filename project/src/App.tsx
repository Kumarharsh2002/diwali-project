...
//   "Happy Diwali! May success light your way! 🎆",
//   "Wishing you peace, happiness, and good fortune! 🎇",
//   "May this Diwali bring endless joy to your family! 💫",
//   "Light up your life with happiness this Diwali! 🪔",
//   "May the divine light of Diwali spread peace and joy! ✨",
// ];
...
//   const handleFirecrackerClick = (firecracker: Firecracker) => {
...
//       audio.src =
//         "data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACBhYqFbF1fdJivrJBhNjVgodDbq2EcBj+a2/LDciUFLIHO8tiJNwgZaLvt559NEAxQp+PwtmMcBjiR1/LMeSwFJHfH8N2QQAoUXrTp66hVFApGn+DyvmwhBSuDy/LOeykGJHjH8N2PQAoUXrTp66hVFApGn+DyvmwhBSuDy/LOeykG";
//       setCurrentWish(
...
//     } else {
//       audio.src =
//         "data:audio/wav;base64,UklGRhIAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YU4AAAA=";
//       audio.play().catch(() => {});
//     }
...
//       <div className="absolute top-10 right-20 w-28 h-28 bg-yellow-200 rounded-full shadow-[0_0_60px_20px_rgba(255,255,200,0.5)] animate-glow"></div>
...
//       {/* Center heading after wish */}
//       {celebrated ? (
//         <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20 animate-fadeIn">
...
//       {/* Firecrackers moving dynamically */}
//       {!showWish && (
//         <div className="absolute inset-0 overflow-hidden">
//           {firecrackers.map((firecracker) => (
//             <motion.button
//               key={firecracker.id}
//               onClick={() => handleFirecrackerClick(firecracker)}
//               disabled={firecracker.clicked}
//               className={`absolute transition-all duration-300 ${
//                 firecracker.clicked
//                   ? "opacity-0 scale-0"
//                   : "opacity-100 hover:scale-125 active:scale-90"
//               }`}
//               animate={{
//                 x: ["0%", "10%", "-10%", "0%"],
//                 y: ["0%", "5%", "-5%", "0%"],
...
//         @keyframes glow { 0%, 100% { box-shadow: 0 0 60px 20px rgba(255,255,200,0.6); } 50% { box-shadow: 0 0 90px 30px rgba(255,255,150,0.9); } }
//         @keyframes bounce-smooth { 0%, 100% { transform: translateY(0); } 50% { transform: translateY(-10px); } }
...
//       audio.src = "/sounds/massive-explosion-3-397984.mp3";
//       setCurrentWish(
//         diwaliWishes[Math.floor(Math.random() * diwaliWishes.length)]
//       );
//       setShowWish(true);
...
//       audio.src = "/sounds/sparkler_fuse_nmwav-14738.mp3";
//       audio.play().catch(() => {});
//     }
